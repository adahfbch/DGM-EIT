...
class CINN(pl.LightningModule):
    def __init__(self, img_size,
        ...
        self.cond_net = ResNetCondNet(img_size=self.img_size,
...
if __name__ == '__main__':
    log_dir = os.path.join(*['..', '', '']) # input your own log_dir
    ...
    tb_logger = pl_loggers.TensorBoardLogger(log_dir, version=f'log_name') #change to your own log_name
    ...
    if not RESUME:
        ...
        if not TEST:
            resume_checkpoint_dir = r'checkpoint_dir'  #change to your own checkpoint_dir
            ...
            test_checkpoint_dir = r'checkpoint_dir' #change to your own checkpoint_dir
