...
from reconstructors.networks.cinn import Flatten, _add_downsample
...
from reconstructors.networks.layers import InvertibleDownsampling, Fixed1x1ConvOrthogonal, GradientDescentStep, InvertibleUpsampling
    ...
    for k in range(num_blocks):
        ...
        if coupling == 'affine':
            nodes.append(Ff.Node(nodes[-1].out0, Fm.GLOWCouplingBlock,
                             {'subnet_constructor':subnet, 'clamp':2.5},
                             #conditions = cond,
